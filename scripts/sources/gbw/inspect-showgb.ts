...
async function main() {
  ...
  page.on('request', (request) => {
    ...
    if (url.includes('gb688.cn') || url.includes('openstd.samr.gov.cn')) {
  ...
  await page.goto('http://c.gb688.cn/bzgk/gb/showGb?type=download&hcno=96019B083A5A59FC7F84895DFFE7500B', {
