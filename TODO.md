...
| 版本 | 日期 | 主要变更 |
|------|------|----------|
| 未发布 | 2026-09-13 | V3 UI 收尾：运行时收敛为 Paper/经典双主题，移除独立任务中心；日志与下载历史按工作台规范重构，移动触控目标统一至 44px |
...
- [x] 全站 UI 重构：统一应用外壳、搜索/资质/CMA、文件与工具、日志/统计/设置/账户和全局弹层；完成 Paper/经典双主题、桌面/手机、键盘焦点与减少动态效果；独立任务中心已按产品决策移除
