...
const FIELDS: CompletionFieldDefinition[] = [
  ...
  field('lifecycle.publishDate', '发布日期', 'lifecycle', 20, { defaultSelected: true, requiresDetail: true, valueType: 'date' }),
  field('lifecycle.implementDate', '实施日期', 'lifecycle', 30, { defaultSelected: true, requiresDetail: true, valueType: 'date' }),
