...
- Labr 可展开查看资源详情；已下载文件会标记并在 PDF 预览时优先直接打开本地副本
...
全站采用统一工作台设计系统，当前只提供 Paper 与经典（Legacy）两套主题：Paper 为默认主题，经典主题主要适配 Chrome 109、Win7 等老设备。下载、同步与导出继续在各自页面提供反馈，不再设置独立任务中心。
